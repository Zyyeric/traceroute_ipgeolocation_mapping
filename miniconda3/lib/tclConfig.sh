...
# installed.
TCL_PREFIX='/home/eric/miniconda3'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/home/eric/miniconda3'
...
TCL_LD_FLAGS='-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,-rpath,/home/eric/miniconda3/lib -Wl,-rpath-link,/home/eric/miniconda3/lib -L/home/eric/miniconda3/lib -Wl,--export-dynamic '
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/home/eric/miniconda3/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/home/eric/miniconda3/include'
...
TCL_PACKAGE_PATH='{/home/eric/miniconda3/lib} '
